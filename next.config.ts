...
const nextConfig: NextConfig = {
  ...
  async headers(){return [
    ...
    {source:"/scorm/:path*",headers:[{key:"X-Frame-Options",value:"SAMEORIGIN"},{key:"Content-Security-Policy",value:"default-src 'self' data: blob:; script-src 'self' 'unsafe-inline' 'unsafe-eval' data: blob:; style-src 'self' 'unsafe-inline' data:; img-src 'self' data: blob: https:; media-src 'self' data: blob: https:; connect-src 'self' https:; frame-src 'self' https: data: blob:; frame-ancestors 'self'; base-uri 'self'; form-action 'self'"}]},
  ]}
};
